...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS('Successfully imported all municipalities'))

        except FileNotFoundError:
            self.stdout.write(self.style.ERROR(f"File {csv_file_path} not found. Please check the file path."))
