...
class ActivitiesTest(StaticLiveServerTestCase):
    ...
    def test_activities(self):
        ...
        # Check that the page does not contain participate section
        self.assertEqual(
            0,
            len(self.browser.find_elements_by_xpath("//section[@id='participation']")),
        )

        # Check that the page contains all current activities
        activity_names = [
            e.text
            for e in self.browser.find_elements_by_xpath(
                "//section[@id='current_activities']/table/tbody/tr/td[@data-label='Aktivitet']"
            )
        ]
        self.assertEqual(4, len(activity_names))
    ...
    def test_membership(self):
        ...
        activities = self.browser.find_elements_by_xpath(
            "//section[@id='current_activities']/table/tbody/tr"
        )
        ...
        self.assertEqual(
            ...
            activities[1].find_element_by_xpath("td[@data-label='Forening']").text,
        )
