...
class ActivityParticipant(models.Model):
    ...
    def paid(self):
        ...
        return not members.models.payment.Payment.objects.filter(activityparticipant=self, confirmed_dtm=None)
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.id:
            if self.activity.is_season():
                ...
                members.models.waitinglist.WaitingList.objects.filter(person=self.member.person).delete()
