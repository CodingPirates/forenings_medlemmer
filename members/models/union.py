...
class Union(models.Model):
    ...
    chairman_phone = models.CharField('Formandens telefonnummer', max_length=20, blank=True)
    ...
    second_chair_phone = models.CharField('Næstformandens telefonnummer', max_length=20, blank=True)
    cashier = models.CharField('Kasserer', max_length=200, blank=True)
    cashier_email = models.EmailField('Kassererens email', blank=True)
    cashier_phone = models.CharField('Kassererens telefonnummer', max_length=20, blank=True)
    ...
    secratary_phone = models.CharField('Sekretærens telefonnummer', max_length=20, blank=True)
