...
class ActivitySignupForm(forms.Form):
    ...
    address_permission = forms.ChoiceField(
        label="Må vi sætte din email samt telefonnummer på holdlisten, der er synlig for de andre deltagere?",
        initial='YES',
        required=True,
        choices=(
            ('YES', 'Ja'),
    ...
    read_conditions = forms.ChoiceField(
        label="Har du <a target='_blank' href=https://codingpirates.dk/coding-pirates-medlemskab/>læst</a> og accepterer du vores handelsbetingelser?",
        initial='YES',
        required=True,
        choices=(
            ('YES', 'Ja'),
    ...
    payment_option = forms.ChoiceField(
        ...
        required=True,
        choices=(
            (Payment.CREDITCARD, 'Betalingskort'),
