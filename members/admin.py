...
class UnionAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        (
            'Navn og Adresse',
            {
                'fields': ('name', 'union_email', 'region', 'streetname', 'housenumber', 'floor', 'door', 'zipcode', 'city', 'placename'),
                'description': '<p>Udfyld navnet på foreningen (f.eks København, vestjylland) og adressen<p>'
            }
        ),
        (
            'Bestyrelsen',
            {
                'fields': ('chairman', 'chairman_email', 'second_chair', 'second_chair_email', 'cashier', 'cashier_email', 'secretary', 'secratary_email', 'boardMembers')
            }
        ),
        (
            'Info',
            {
                ...
                'description': 'Indsæt et link til jeres vedtægter, hvornår I er stiftet (har holdt stiftende generalforsamling) og jeres bankkonto hvis I har sådan en til foreningen.'
            }
        )
    ]
    ...
    fieldsets = (
        ...
        (
            'Aktivitet',
            {
                ...
                'fields': ('name', 'open_hours', 'description', 'start_date', 'end_date',)
            }
        ),
        (
            'Lokation og ansvarlig',
            {
                ...
                'fields': ('responsible_name', 'responsible_contact', 'streetname', 'housenumber', 'floor', 'door', 'zipcode', 'city', 'placename')
            }
        ),
        (
            'Tilmeldingsdetaljer',
            {
                ...
                'fields': ('instructions', 'open_invite', 'price_in_dkk', 'signup_closing', 'max_participants', 'min_age', 'max_age',)
            }
        )
    )
    ...
    fieldsets = (
        (
            None,
            {
                ...
                'fields': ('person', 'activity', 'invite_dtm', 'expire_dtm', 'rejected_dtm')
            }
        ),
    )
