...
class DailyStatisticsDepartment(models.Model):
    ...
    current_activity_participants_age_avg = models.FloatField('Deltagere på aktiviteter gennemsnit alder', null=False, blank=False, default=0)
    current_activity_participants_age_min = models.FloatField('Deltagere på aktiviteter yngste alder', null=False, blank=False, default=0)
    current_activity_participants_age_max = models.FloatField('Deltagere på aktiviteter ældste alder', null=False, blank=False, default=0)
    ...
    volunteers_age_avg = models.FloatField('Frivillige gennemsnit alder', null=False, blank=False, default=0)
    volunteers_age_min = models.FloatField('Frivillige yngste alder', null=False, blank=False, default=0)
